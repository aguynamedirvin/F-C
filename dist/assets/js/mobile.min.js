!function() {
    ...
    function FastClick(layer, options) {
        ...
        var oldOnClick;
        if (options = options || {}, this.trackingClick = !1, 
        this.trackingClickStart = 0, this.targetElement = null, 
        this.touchStartX = 0, this.touchStartY = 0, this.lastTouchIdentifier = 0, 
    ...
    */
    ...
    FastClick.prototype.onTouchEnd = function(event) {
        ...
        this.trackingClickStart = 0, deviceIsIOSWithBadTarget && (touch = event.changedTouches[0], 
    ...
    FastClick.notNeeded = function(layer) {
        ...
        metaViewport && (-1 !== metaViewport.content.indexOf("user-scalable=no") || document.documentElement.scrollWidth <= window.outerWidth)) ? !0 : "none" === layer.style.touchAction || "manipulation" === layer.style.touchAction);
    }, /**
