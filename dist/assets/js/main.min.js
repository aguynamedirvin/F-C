...
$(document).ready(function() {
    ...
    var $L = 868, $menu_navigation = $("#site-nav"), $hamburger_icon = ($("#nav-cart-trigger"), 
    $("#hamburger-menu")), $lateral_cart = $(".nav-cart"), $shadow_layer = $("#shadow-layer");
...
function(factory) {
    ...
    Slick = function() {
        ...
        if (_.dragging = !1, _.shouldClick = !(_.touchObject.swipeLength > 10), 
