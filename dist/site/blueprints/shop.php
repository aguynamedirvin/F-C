...
fields:
  ...
  main-slider:
    ...
    type: structure
    entry: >
        <img src="/fc_new/content/2-shop/{{image}}" width="200" /><br /><p>Title: <b style="text-transform: capitalize">{{title}}</b></p>
    fields:
      title:
        label: Slide title
        type: text
      ...
      summary:
        ...
        type: textarea
        buttons: false
        help: This will only appear on the slide if not empty.
      image:
        label: Slide Image
        type: selector
        mode: single
